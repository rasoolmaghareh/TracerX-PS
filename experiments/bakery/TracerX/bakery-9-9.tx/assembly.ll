...
@limit = global i32 9, align 4
@n_bread = global i32 0, align 4
@.str = private unnamed_addr constant [2 x i8] c"c\00", align 1
@.str1 = private unnamed_addr constant [15 x i8] c"Id: %d, PC %d\0A\00", align 1
@pc = common global [9 x i32] zeroinitializer, align 16
@ticket = common global [9 x i32] zeroinitializer, align 16
...
@bread = common global [243 x i32] zeroinitializer, align 16
...
while.body:                                       ; preds = %while.cond
  ...
  %call = call i32 @klee_range(i32 0, i32 9, i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0)), !dbg !151
...
for.end:                                          ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [9 x i32]* @pc, i32 0, i64 %idxprom, !dbg !157
  ...
  %arrayidx4 = getelementptr inbounds [9 x i32]* @pc, i32 0, i64 %idxprom3, !dbg !158
...
sw.bb:                                            ; preds = %for.end
  ...
  %arrayidx7 = getelementptr inbounds [9 x i32]* @ticket, i32 0, i64 %idxprom6, !dbg !159
  store i32 %add, i32* %arrayidx7, align 4, !dbg !159
  %11 = load i32* %id, align 4, !dbg !159
  %idxprom8 = sext i32 %11 to i64, !dbg !159
  %arrayidx9 = getelementptr inbounds [9 x i32]* @pc, i32 0, i64 %idxprom8, !dbg !159
...
if.then:                                          ; preds = %sw.bb11
  ...
  %arrayidx14 = getelementptr inbounds [9 x i32]* @pc, i32 0, i64 %idxprom13, !dbg !163
...
sw.bb16:                                          ; preds = %for.end
  ...
  %arrayidx18 = getelementptr inbounds [9 x i32]* @ticket, i32 0, i64 %idxprom17, !dbg !168
  store i32 0, i32* %arrayidx18, align 4, !dbg !168
  %18 = load i32* %id, align 4, !dbg !168
  %idxprom19 = sext i32 %18 to i64, !dbg !168
  %arrayidx20 = getelementptr inbounds [9 x i32]* @pc, i32 0, i64 %idxprom19, !dbg !168
...
for.cond24:                                       ; preds = %for.inc33, %while.end
  ...
  %cmp25 = icmp slt i32 %21, 243, !dbg !173
...
land.lhs.true:                                    ; preds = %for.cond24
  ...
  %arrayidx27 = getelementptr inbounds [243 x i32]* @bread, i32 0, i64 %idxprom26, !dbg !173
...
for.body29:                                       ; preds = %land.lhs.true
  ...
  %arrayidx31 = getelementptr inbounds [243 x i32]* @bread, i32 0, i64 %idxprom30, !dbg !173
...
land.lhs.true:                                    ; preds = %for.body
  ...
  %arrayidx3 = getelementptr inbounds [9 x i32]* @ticket, i32 0, i64 %idxprom2, !dbg !179
  %4 = load i32* %arrayidx3, align 4, !dbg !179
  %5 = load i32* %i, align 4, !dbg !179
  %idxprom4 = sext i32 %5 to i64, !dbg !179
  %arrayidx5 = getelementptr inbounds [9 x i32]* @ticket, i32 0, i64 %idxprom4, !dbg !179
...
land.lhs.true:                                    ; preds = %for.body
  ...
  %arrayidx = getelementptr inbounds [9 x i32]* @pc, i32 0, i64 %idxprom, !dbg !186
...
for.end:                                          ; preds = %for.cond
  ...
  %arrayidx8 = getelementptr inbounds [243 x i32]* @bread, i32 0, i64 %idxprom7, !dbg !191
...
if.then:                                          ; preds = %for.body
  ...
  %arrayidx3 = getelementptr inbounds [9 x i32]* @ticket, i32 0, i64 %idxprom2, !dbg !196
...
!19 = metadata !{i32 786484, i32 0, null, metadata !"pc", metadata !"pc", metadata !"", metadata !5, i32 13, metadata !20, i32 0, i32 1, [9 x i32]* @pc, null} ; [ DW_TAG_variable ] [pc] [line 13] [def]
!20 = metadata !{i32 786433, null, null, metadata !"", i32 0, i64 288, i64 32, i32 0, i32 0, metadata !8, metadata !21, i32 0, null, null, null} ; [ DW_TAG_array_type ] [line 0, size 288, align 32, offset 0] [from int]
!21 = metadata !{metadata !22}
!22 = metadata !{i32 786465, i64 0, i64 9}        ; [ DW_TAG_subrange_type ] [0, 8]
!23 = metadata !{i32 786484, i32 0, null, metadata !"ticket", metadata !"ticket", metadata !"", metadata !5, i32 13, metadata !20, i32 0, i32 1, [9 x i32]* @ticket, null} ; [ DW_TAG_variable ] [ticket] [line 13] [def]
!24 = metadata !{i32 786484, i32 0, null, metadata !"bread", metadata !"bread", metadata !"", metadata !5, i32 13, metadata !25, i32 0, i32 1, [243 x i32]* @bread, null} ; [ DW_TAG_variable ] [bread] [line 13] [def]
!25 = metadata !{i32 786433, null, null, metadata !"", i32 0, i64 7776, i64 32, i32 0, i32 0, metadata !8, metadata !26, i32 0, null, null, null} ; [ DW_TAG_array_type ] [line 0, size 7776, align 32, offset 0] [from int]
!26 = metadata !{metadata !27}
!27 = metadata !{i32 786465, i64 0, i64 243}      ; [ DW_TAG_subrange_type ] [0, 242]
