...
@bread = common global [39 x i32] zeroinitializer, align 16
...
for.cond24:                                       ; preds = %for.inc33, %while.end
  ...
  %cmp25 = icmp slt i32 %21, 39, !dbg !173
...
land.lhs.true:                                    ; preds = %for.cond24
  ...
  %arrayidx27 = getelementptr inbounds [39 x i32]* @bread, i32 0, i64 %idxprom26, !dbg !173
...
for.body29:                                       ; preds = %land.lhs.true
  ...
  %arrayidx31 = getelementptr inbounds [39 x i32]* @bread, i32 0, i64 %idxprom30, !dbg !173
...
for.end:                                          ; preds = %for.cond
  ...
  %arrayidx8 = getelementptr inbounds [39 x i32]* @bread, i32 0, i64 %idxprom7, !dbg !191
...
!24 = metadata !{i32 786484, i32 0, null, metadata !"bread", metadata !"bread", metadata !"", metadata !5, i32 13, metadata !25, i32 0, i32 1, [39 x i32]* @bread, null} ; [ DW_TAG_variable ] [bread] [line 13] [def]
!25 = metadata !{i32 786433, null, null, metadata !"", i32 0, i64 1248, i64 32, i32 0, i32 0, metadata !8, metadata !26, i32 0, null, null, null} ; [ DW_TAG_array_type ] [line 0, size 1248, align 32, offset 0] [from int]
!26 = metadata !{metadata !27}
!27 = metadata !{i32 786465, i64 0, i64 39}       ; [ DW_TAG_subrange_type ] [0, 38]
