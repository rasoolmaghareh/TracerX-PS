...
int main() {
  ...
  vector<int> x6 = {0, 0, 0, 5, 0, 1, 0, 3, 4, 6, 8, 7, 2, 0};
  vector<int> y6 = {7, 8, 0, 0, 0, 0, 0, 0, 1, 2, 3, 4, 5, 6};

  vector<int> x7 = {6, 0, 5, 8, 0, 0, 2, 0, 3, 4, 1, 7, 0, 0};
  vector<int> y7 = {7, 8, 0, 0, 0, 0, 0, 0, 1, 2, 3, 4, 5, 6};
