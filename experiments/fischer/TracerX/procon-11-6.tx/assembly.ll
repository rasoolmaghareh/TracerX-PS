...
@pc = global [11 x i32] zeroinitializer, align 16
@lock = global i32 -1, align 4
@tick = global i32 0, align 4
@savetick = global [11 x i32] zeroinitializer, align 16
...
if.end:                                           ; preds = %entry
  %call1 = call i32 @klee_range(i32 0, i32 10, i8* getelementptr inbounds ([3 x i8]* @.str1, i32 0, i32 0)), !dbg !144
  store i32 %call1, i32* %id, align 4, !dbg !144
  %3 = load i32* %id, align 4, !dbg !145
  %idxprom = sext i32 %3 to i64, !dbg !145
  %arrayidx = getelementptr inbounds [11 x i32]* @pc, i32 0, i64 %idxprom, !dbg !145
...
if.then3:                                         ; preds = %sw.bb
  ...
  %arrayidx5 = getelementptr inbounds [11 x i32]* @pc, i32 0, i64 %idxprom4, !dbg !149
...
sw.bb7:                                           ; preds = %if.end
  ...
  %arrayidx9 = getelementptr inbounds [11 x i32]* @savetick, i32 0, i64 %idxprom8, !dbg !152
  store i32 %9, i32* %arrayidx9, align 4, !dbg !152
  %11 = load i32* %id, align 4, !dbg !152
  %idxprom10 = sext i32 %11 to i64, !dbg !152
  %arrayidx11 = getelementptr inbounds [11 x i32]* @pc, i32 0, i64 %idxprom10, !dbg !152
...
sw.bb13:                                          ; preds = %if.end
  ...
  %arrayidx15 = getelementptr inbounds [11 x i32]* @savetick, i32 0, i64 %idxprom14, !dbg !153
...
if.then18:                                        ; preds = %sw.bb13
  ...
  %arrayidx20 = getelementptr inbounds [11 x i32]* @pc, i32 0, i64 %idxprom19, !dbg !155
...
if.then25:                                        ; preds = %sw.bb23
  ...
  %arrayidx27 = getelementptr inbounds [11 x i32]* @pc, i32 0, i64 %idxprom26, !dbg !160
...
land.lhs.true:                                    ; preds = %if.end
  ...
  %arrayidx = getelementptr inbounds [11 x i32]* @pc, i32 0, i64 %idxprom, !dbg !170
...
!14 = metadata !{i32 786484, i32 0, null, metadata !"pc", metadata !"pc", metadata !"", metadata !5, i32 6, metadata !15, i32 0, i32 1, [11 x i32]* @pc, null} ; [ DW_TAG_variable ] [pc] [line 6] [def]
!15 = metadata !{i32 786433, null, null, metadata !"", i32 0, i64 352, i64 32, i32 0, i32 0, metadata !8, metadata !16, i32 0, null, null, null} ; [ DW_TAG_array_type ] [line 0, size 352, align 32, offset 0] [from int]
!16 = metadata !{metadata !17}
!17 = metadata !{i32 786465, i64 0, i64 11}       ; [ DW_TAG_subrange_type ] [0, 10]
...
!20 = metadata !{i32 786484, i32 0, null, metadata !"savetick", metadata !"savetick", metadata !"", metadata !5, i32 6, metadata !15, i32 0, i32 1, [11 x i32]* @savetick, null} ; [ DW_TAG_variable ] [savetick] [line 6] [def]
