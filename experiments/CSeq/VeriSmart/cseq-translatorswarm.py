...
def main():
    ...
    # Parse command-line.
    try:
        shortargs = "hHdi:o:I:e:DSMvl:LC:YZ:"
        longargs = [ "help", "detailedhelp", "detail", "input=", "output=", "include=",
                     "error-label=",
                     "debug", "symbols", "modules", "version",
                     "load=", "list-chains",
                     "config-swarm=", "contextswitch", "list-instance=", "suffix=", "dump-env"
    ...
    if cseqenv.contextswitch:
        ...
        config = core.utils.parseConfig(cseqenv.configFile)
