...
def extractThreadNameFromPthreadCreate(rawthreadname):
    ''' This function will extract thread name from pthread_create '''
    pass

def json_serialize(obj):
    processed_obj = {}
    for key in obj:
        processed_obj[':'.join([str(i) for i in key])] = obj[key]
